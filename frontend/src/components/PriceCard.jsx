...
const PriceCard = () => {
    ...
    const flashClasses = flashSide === 'buy' ? 'ring-2 ring-emerald-500/50' : flashSide === 'sell' ? 'ring-2 ring-orange-500/50' : 'border-neutral-800';
            ...
            <div className="flex justify-between items-end border-t border-neutral-800 pt-4">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex gap-3">
                        <div className="flex flex-col"><span className="text-[7px] text-neutral-500 font-bold">Fastest</span><span className={`text-[11px] font-mono font-black ${data.fees?.fastestFee > 100 ? 'text-orange-400' : 'text-emerald-400'}`}>{data.fees?.fastestFee || '--'} <span className="text-[7px] opacity-60">sat/vB</span></span></div>
                        <div className="flex flex-col border-l border-neutral-800 pl-3"><span className="text-[7px] text-neutral-500 font-bold">1 Hour</span><span className="text-[11px] font-mono font-black text-neutral-300">{data.fees?.hourFee || '--'} <span className="text-[7px] opacity-60">sat/vB</span></span></div>
                    </div>
                </div>
